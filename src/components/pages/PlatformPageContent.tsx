...
const proofCards = [
  {
    title: "Capture",
    body: "Track the initiating agent, workflow session, changed object, and the before or after state needed for recovery.",
  },
  {
    title: "Assess",
    body: "Map Entra, Microsoft 365, and downstream dependencies to understand what else was touched and what order matters.",
  },
  {
    title: "Recover",
    body: "Coordinate rollback, restoration, and compensating actions so operators return to a trusted state instead of restoring one object at a time.",
  },
];
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[0.9fr_1.1fr]">
            <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
              ...
              <motion.p variants={fadeUp} className="mt-6 max-w-xl text-lg leading-relaxed text-text-secondary">
                As AI agents gain the ability to change identities, modify access, update data, and trigger business workflows, enterprises need more than visibility. They need confidence that harmful autonomous actions can be understood, contained, and safely recovered.
              </motion.p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <SectionHeader
              ...
              subtitle="The real question is not whether an AI agent can act. It is whether your enterprise can recover when it acts incorrectly. KavachIQ Autonomous Assurance gives teams the ability to trace autonomous actions, assess impact, and restore a known-good state across critical systems."
            />
          </div>
        </div>
      </section>
      ...
      <section className="relative bg-bg-surface/50 py-24 sm:py-28" id="platform-proof">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <SectionHeader
            ...
            subtitle="The platform is built around an operator-ready incident workflow, not just passive monitoring."
          />
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            ...
            <div className="rounded-[24px] border border-accent/20 bg-accent/[0.06] p-6">
              ...
              <h3 className="mt-4 text-2xl font-semibold text-text-primary">Designed for the moment an AI workflow goes wrong.</h3>
              <ul className="mt-6 space-y-4 text-sm text-text-secondary">
                ...
                <BulletItem>Return to a known-good state instead of restoring isolated objects without context.</BulletItem>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <CapabilityCard
              ...
              description="Track critical agent-driven actions across systems with the context needed to understand who changed what and when."
            />
            <CapabilityCard
              icon={<RadiusIcon />}
            ...
            <CapabilityCard
              ...
              description="Coordinate rollback, restoration, and compensating actions across systems instead of forcing operators into app-by-app recovery."
            />
            <CapabilityCard
          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <motion.p variants={fadeUp} className="mt-6 text-lg leading-relaxed text-text-secondary">
                Microsoft Entra is where authority begins. Harmful autonomous changes to users, groups, app access, service principals, and identity policies can ripple into downstream systems and create security, operational, and compliance issues.
              </motion.p>
              <motion.ul variants={fadeUp} className="mt-8 space-y-3">
                <BulletItem>Trace agent-driven identity changes across users, groups, applications, and service principals.</BulletItem>
                <BulletItem>Understand downstream app access, provisioning, and permission fallout before acting.</BulletItem>
                <BulletItem>Recover the control plane first so data and collaboration recovery happens from a trusted baseline.</BulletItem>
                <BulletItem>Keep operators in control for risky identity restoration decisions.</BulletItem>
              </motion.ul>
            </motion.div>
            ...
            <div className="rounded-[28px] border border-border-primary bg-bg-surface/70 p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ["Users and groups", "Membership drift, privilege expansion, or bad lifecycle changes."],
                  ["Applications", "App registrations, service principals, and access paths that agents alter."],
                  ["Policies", "Identity guardrails and settings that shape downstream access."],
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-16 lg:grid-cols-2">
            <div className="order-2 rounded-[28px] border border-border-primary bg-bg-primary/65 p-6 lg:order-1">
              <div className="grid gap-4 sm:grid-cols-2">
                {[
                  ["SharePoint and OneDrive", "Trace content, permission, and collaboration changes tied to autonomous workflows."],
                  ["Exchange", "Understand mailbox, messaging, and communication impact when agents act at scale."],
                  ["Permission fallout", "Connect M365 data impact to Entra identity drift and access changes."],
            ...
            >
              ...
              <motion.p variants={fadeUp} className="mt-6 text-lg leading-relaxed text-text-secondary">
                AI agents increasingly touch SharePoint, OneDrive, Exchange, and related collaboration workflows. Harmful autonomous changes to files, permissions, content, or messaging can disrupt operations and create risk quickly.
              </motion.p>
              <motion.ul variants={fadeUp} className="mt-8 space-y-3">
                <BulletItem>Identify harmful changes across M365 workloads, not just isolated objects.</BulletItem>
                <BulletItem>Understand affected content, permissions, and collaboration dependencies.</BulletItem>
                <BulletItem>Coordinate recovery with business context and the right dependency order.</BulletItem>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <ProcessStep
              step={1}
              title="Capture"
              description="KavachIQ records critical autonomous actions across supported systems, including the initiating agent and workflow session."
            />
            <ProcessStep
              step={2}
              title="Assess"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid items-center gap-14 lg:grid-cols-[0.92fr_1.08fr]">
            ...
            <div className="rounded-[28px] border border-border-primary bg-bg-primary/65 p-6">
              <h3 className="text-2xl font-semibold text-text-primary">What buyers should expect from the first conversation</h3>
              <div className="mt-6 grid gap-4 sm:grid-cols-2">
                {[
                  ["Scope", "Which Entra and M365 surfaces matter most for your first recovery wedge."],
                  ["Risk", "What kinds of harmful autonomous changes matter most to your operators."],
                  ["Workflow", "How recovery should work when identity and data both change."],
